      ...
      <div className="last">
        ...
        <div className="last_bb">
          <h4>
            ...
            продукцию по конкурент о способным ценам. Мы занимаемся
            производством полного цикла от изготовления лекала до отправки
            готовой партии продукции.
          </h4>
        </div>
        <hr style={{ width: "300px" }} />
            ...
            <Typography>
              <div className="acc">
                <h3>
                  ...
                  количество операций по пошиву изделия! Разработка: <br />
                  -Изготовление лекал <br /> -Пошив образца <br /> -Ткань +
                  фурнитура
                  <br /> -Конструирование изделия (доработка) 5000₽ Далее,
                  градация каждого размера от 1000₽ до 2500₽ (в зависимости от
                  модели) Оплату возможно произвести на банковскую карту
                </h3>
              </div>
            </Typography>
          </AccordionDetails>
